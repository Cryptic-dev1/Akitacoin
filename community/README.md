...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Akitacoin that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like akitacoind does for AKIC)
...
* Run a contest: AKIC prize for best idea for new Akitacoin based Business
...
* Back-end API platform for Akitacoin
    * Other people to hit high-availablity API
* Fee system to pay AKIC fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of AKIC for fees.
...
* #KYC tagger - store info and tag Akitacoin addresses
* #ACCREDITED - verify accredited status and tag Akitacoin addresses
 
### Technical Consultant
* Help companies apply Akitacoin capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional AKIC and asset support


### Areas for Akitacoin Innovation
* Financial
