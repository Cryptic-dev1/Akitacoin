...
This document provides guidelines for internationalization of the Akitacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `akitacoin_en.ts` remains unchanged.
