Akitacoin Core version *2.1.0* is now available!!
==============

  <https://github.com/JustAResearcher/Akitacoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/JustAResearcher/Akitacoin/commits/release_2.1.0>
