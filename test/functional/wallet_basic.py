...
class WalletTest(AkitacoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 AKIC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 AKIC with subtract fee from amount
        ...
        # Sendmany 10 AKIC with subtract fee from amount
