...
class TestAkitacoinCli(AkitacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `akitacoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `akitacoin-cli -getinfo` and the RPCs data is retrieved from.")
