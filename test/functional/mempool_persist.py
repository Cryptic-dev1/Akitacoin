...
By default, akitacoind will dump mempool on shutdown and
...
class MempoolPersistTest(AkitacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give akitacoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent akitacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
