...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AkitacoinTestFramework
    pass

class ExampleTest(AkitacoinTestFramework):
    # Each functional test is a subclass of the AkitacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AkitacoinTestFramework class so other tests can use it."""
