...
class TxnMallTest(AkitacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AKIC:
        ...
        # First: use raw transaction API to send 1240 AKIC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AKIC coin each
        ...
        # Node0's balance should be starting balance, plus 50AKIC for another
        ...
        # Node0's total balance should be starting balance, plus 100AKIC for 
