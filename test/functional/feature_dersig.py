...
class BIP66Test(AkitacoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # akitacoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and akitacoind produces more specific reject
            # reasons.
