...
find ${DISTNAME}/bin -type f -executable -exec ../akitacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../akitacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/akitacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/akitacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
