...
issuing of akitas is carried out collectively by the network.
...
%description libs
This package provides the akitaconsensus shared libraries. These libraries
...
akitaconsensus shared library. If you are developing or compiling software
...
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/akita16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/akita32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/akita64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/akita128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/akita256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/akita256.png %{buildroot}%{_datadir}/pixmaps/akita16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/akita256.png %{buildroot}%{_datadir}/pixmaps/akita32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/akita256.png %{buildroot}%{_datadir}/pixmaps/akita64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/akita256.png %{buildroot}%{_datadir}/pixmaps/akita128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/akita256.png %{buildroot}%{_datadir}/pixmaps/akita256.xpm
