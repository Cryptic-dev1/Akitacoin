...
%{_sbindir}/semanage port -a -t akitacoin_port_t -p tcp 8766
%{_sbindir}/semanage port -a -t akitacoin_port_t -p tcp 7787
%{_sbindir}/semanage port -a -t akitacoin_port_t -p tcp 18766
%{_sbindir}/semanage port -a -t akitacoin_port_t -p tcp 17787
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 7787
	%{_sbindir}/semanage port -d -p tcp 18766
	%{_sbindir}/semanage port -d -p tcp 17787
