...
reference the release tarball available from https://akitacoin.net/bin/ and
`Source1` should reference the BerkeleyDB source.

Sources 10-99 are for source files that are maintained in the
[Akitacoin git repository](https://github.com/AkitacoinChain/Akitacoin) but are not part of
