...
rm -rf ~/akitacoincoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../akitacoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../akitacoincoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/akitacoincoin/temp
cd ~/akitacoincoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/akitacoincoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/akitacoincoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
