...
// Copyright (c) 2017-2024 The Akitacoi Core developers
...
UniValue createrawtransaction(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            // TODO if we decide to remove the consensus check from issue 675 https://github.com/Cryptic-dev1/Akitacoin/issues/675
