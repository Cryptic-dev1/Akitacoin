...
#ifndef AKITACOIN_RPCSERVER_H
#define AKITACOIN_RPCSERVER_H
...
/**
 * Akitacoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isAKIC = true);
