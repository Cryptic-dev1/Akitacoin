 ...
 */
#ifndef AKITACOIN_UTIL_H
#define AKITACOIN_UTIL_H
...
extern const char *const AKITACOIN_CONF_FILENAME;
extern const char *const AKITACOIN_PID_FILENAME;
...
{
    std::string s = strprintf("akitacoin-%s", name);
