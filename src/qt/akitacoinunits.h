...
#ifndef AKITACOIN_QT_AKITACOINUNITS_H
#define AKITACOIN_QT_AKITACOINUNITS_H
...
/** akitacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AkitacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AkitacoinUnits(QObject *parent);
...
typedef AkitacoinUnits::Unit AkitacoinUnit;

#endif // AKITACOIN_QT_AKITACOINUNITS_H
