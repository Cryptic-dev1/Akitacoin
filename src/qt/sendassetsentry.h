...
#ifndef AKITACOIN_QT_SENDASSETSENTRY_H
#define AKITACOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending akitacoin.
...
#endif // AKITACOIN_QT_SENDASSETSENTRY_H
