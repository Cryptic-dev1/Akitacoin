...
#ifndef AKITACOIN_QT_RECEIVECOINSDIALOG_H
#define AKITACOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of akitacoin */
...
#endif // AKITACOIN_QT_RECEIVECOINSDIALOG_H
