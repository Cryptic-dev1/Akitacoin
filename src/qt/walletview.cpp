...
void WalletView::setAkitacoinGUI(AkitacoinGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? AkitacoinGUI::HD44_ENABLED : _walletModel->hdEnabled() ? AkitacoinGUI::HD_ENABLED : AkitacoinGUI::HD_DISABLED);
