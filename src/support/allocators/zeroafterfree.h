...
#ifndef AKITACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define AKITACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // AKITACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
