...
#ifndef AKITACOIN_TEST_SCRIPTNUM10_H
#define AKITACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Akitacoin Core 0.10.0, for cross-comparison.
 */
public:
