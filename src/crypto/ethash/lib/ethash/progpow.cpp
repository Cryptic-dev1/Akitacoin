...
static const uint32_t akitacoincoin_kawpow[15] = {
        0x00000072, //R
        0x00000041, //A
        0x00000056, //V
        0x00000045, //E
    ...
    uint64_t nonce) noexcept
{
...

    {
        ...
        // 3rd apply akitacoincoin input constraints
        for (int i = 10; i < 25; i++)
            state[i] = akitacoincoin_kawpow[i-10];
    ...
    // 3rd apply akitacoincoin input constraints
    for (int i = 16; i < 25; i++)
        state[i] = akitacoincoin_kawpow[i - 16];
