...
The following applies to code changes to the Akitacoin project (and related
projects) and is not to be confused with overall Akitacoin
Network Protocol consensus changes.

Whether a pull request is merged into Akitacoin rests with the project merge
...
The AkitacoinQT-SIG selects a release manager for each Akitacoin release.
